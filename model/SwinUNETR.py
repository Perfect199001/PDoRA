...
#from model.fine_tuning.ft_swinunetr.svd import MLPBlock as Mlp
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask_matrix):
        ...
        if self.use_checkpoint:
            ...
            x = self.forward_part1(x, mask_matrix)      # 这一部分对应的是transformer(WA & SWA)
            #print(x.shape)
...
if __name__ == "__main__":
    ...
    #model = nn.DataParallel(model)   # 两块GPU并行计算
    input = torch.zeros((2,1,64,64,64)).cuda()
